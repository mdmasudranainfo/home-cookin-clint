...
const HappyClint = () => {
  return (
    <div className=" w-9/12 mx-auto grid lg:grid-cols-3 grid-cols-1  bg-primary my-4 rounded-2xl p-5 ">
      ...
      <div className="">
        <div className="text-3xl font-semibold text-center">Happy Clint</div>
        <div className="logo flex justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <h2 className="text-4xl text-center">400</h2>
      </div>

      <div className="">
        <div className="text-3xl font-semibold text-center">Rating</div>
        <div className="logo flex justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <h2 className="text-4xl text-center">5.9</h2>
      </div>
    </div>
  );
};
